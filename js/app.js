(() => {
    ...
    let formValidate = {
        ...
        addError(formRequiredItem) {
            ...
            if (formRequiredItem.dataset.error) formRequiredItem.parentElement.insertAdjacentHTML("afterbegin", `<div class="form__error">${formRequiredItem.dataset.error}</div>`);
        },
    ...
    function buildBlogItem(item) {
        ...
        item.image ? blogItemTemplate += `<a href="${item.url}" class="item-blog__image"><img class="item-blog__images ibg" src="${item.image}"\n\t\t\t\t\t\t\t\t\talt="Image"></a>` : null;
    ...
    function documentActions(e) {
        const targetElement = e.target;
        if (targetElement.closest(".blog__view-more")) e.preventDefault();
    }
    window["FLS"] = true;
    addLoadedClass();
    menuInit();
